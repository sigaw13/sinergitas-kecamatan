...
// Gunakan DATABASE_URL dari Railway atau fallback ke SQLite
const pool = new Pool({
...
async function initializeDatabase() {
  ...
  try {
    ...
    if (result.rows[0].count === 0) {
      ...
      await client.query(
        'INSERT INTO kecamatan (nama, username, password, nama_pengelola, email) VALUES ($1, $2, $3, $4, $5)',
        ['Admin Pusat', 'admin', adminPassword, 'Administrator', 'admin@sumedangkab.go.id']
      );

      for (const kc of kecamatans) {
